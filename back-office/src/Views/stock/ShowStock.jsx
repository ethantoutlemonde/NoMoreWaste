          ...
          {filteredProducts.map(product => (
            <tr key={product.id} className="bg-white border-b   hover:bg-gray-50 ">
              ...
              <td className="px-6 py-4">
                {editableProductId === product.id ? (
                  <>
                    <button onClick={() => handleModifyProduct(product.id)} className="font-medium text-blue-600  hover:underline">
                      {t('Validate')}
                    </button>
                    <button onClick={() => setEditableProductId(null)} className="font-medium text-red-600  hover:underline ml-2">
                      {t('Cancel')}
                    </button>
                  </>
                ) : (
                  <>
                    <button onClick={() => handleEditClick(product)} className="font-medium text-blue-600  hover:underline">
                      {t('Modify')}
                    </button>
                    <button onClick={() => handleDeleteProduct(product.id)} className="font-medium text-red-600  hover:underline ml-2">
                      {t('Delete')}
                    </button>
                  </>
                )}
                <button type="button" onClick={() => handleViewProduct(product)}className="font-medium text-purple-600  hover:underline ml-2">
                      {t('view')}
                </button>
              </td>
            </tr>
