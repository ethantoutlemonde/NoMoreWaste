...
export default function OutreachParticipants({outreach, fetchData}) {
    ...
    const handleDelete = async () => {
        ...
        try {
            await Promise.all(selection.map(itemId => axiosClient.delete(`/api/outreach/${outreach.id}/participants`, {params: {volunteer_id: itemId}})));
    ...
    const handleAdd = () => {
        ...
        axiosClient.post(`/api/outreach/${outreach.id}/participants`, {volunteer_id: selectedVolunteer})
        .then(response => {
