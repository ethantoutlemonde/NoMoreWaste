...
export default function PartnerSupermarketUpdate() {
    ...
    const submit = (e) => {
        ...
        axiosClient.patch(`/api/supermarket/${id}`, data)
        .then((response) => {
    ...
    return (
        ...
        <div className='flex justify-center'>   
            ...
            <form onSubmit={submit} className="bg-slate-50 p-10 rounded-xl  mt-12" style={{maxWidth: 500 + "px"}}>
                ...
                <h1 className='font-semibold text-2xl mb-4'>{t("Update Supermarket")}</h1>
